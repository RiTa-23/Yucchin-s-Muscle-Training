        ...
        <div className="min-h-screen bg-muted/20 p-8">
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                <div className="flex flex-col items-center justify-center min-h-[60vh]">
                    <Card className="hover:shadow-md transition-shadow cursor-pointer border-primary/20 w-full max-w-2xl transform hover:scale-[1.01] transition-all" onClick={() => navigate("/camera")}>
                        <CardHeader>
                        ...
                        <CardFooter>
                            <Button className="w-full text-lg py-6">カメラを起動</Button>
                        </CardFooter>
                    </Card>
                </div>
            </div>
