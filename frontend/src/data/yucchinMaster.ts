...
export const YUCCHIN_MASTER: YucchinMaster[] = [
    ...
    { type: 3, name: "ティールゆっちんブーケ", rarity: 'NORMAL', imageUrl: yucchin3 },
    { type: 4, name: "ブルーゆっちんブーケ", rarity: 'NORMAL', imageUrl: yucchin4 },
    ...
    { type: 103, name: "カラフルゆっちんブーケ", rarity: 'RARE', imageUrl: yucchin103 },
